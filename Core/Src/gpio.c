...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, STEP_DIAG_Pin|MS1_Pin|MS2_Pin|ELECTROMAGNET_RFID_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, STEP_ENN_Pin|DIR_Pin|STDBY_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : STEP_DIAG_Pin ELECTROMAGNET_RFID_Pin */
  GPIO_InitStruct.Pin = STEP_DIAG_Pin|ELECTROMAGNET_RFID_Pin;
  ...
  /*Configure GPIO pins : SW_RFID_U_Pin SW_RFID_D_Pin */
  GPIO_InitStruct.Pin = SW_RFID_U_Pin|SW_RFID_D_Pin;
